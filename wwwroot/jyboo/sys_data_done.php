...
function PutInfo($msg1,$msg2)
{
    ...
    $msginfo = "<html>\n<head>
        ...
        <br/>
        <div style='width:400px;padding-top:4px;height:24;font-size:10pt;border-left:1px solid #cccccc;border-top:1px solid #cccccc;border-right:1px solid #cccccc;background-color:#DBEEBD;'>易乡街提示信息！</div>
